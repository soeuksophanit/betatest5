...
// $(".light-mode-icon").click(() => {
//   $(".light-mode-icon").toggleClass("active-mode");
//   $(".dark-mode-icon").toggleClass("active-mode");
//   // -------------------------
//   $("body").toggleClass("activate");
//   // -------------------------
//   // -------------------------
//   $(".navbar-wrap").toggleClass("activate");
//   // -------------------------
//   $(".news-content").toggleClass("activate");
//   //---------------------------------
//   $("h4.title-news-category").toggleClass("activate");
//   //---------------------
//   $(".title-news").toggleClass("activate");
//   //-----------------------------
//   $(".date").toggleClass("activate");
//   // -------------------------
//   $(".dots").toggleClass("activate");
//   //-----------------------
//   $(".amount-view").toggleClass("activate");
//   // ----------------------
//   $(".read").toggleClass("activate");
//   //------------------------
//   $(".read-more svg").toggleClass("activate");
//   //-------------------
//   $(".link-1-demo").toggleClass("activate");
//   //-------------------
//   $(".logo").toggleClass("activate");
//   //--------------
//   $(".nav-link a").toggleClass("activate");
//   // ----------------
//   $(".nav-link").toggleClass("activate");
//   //---------------
//   $(".search").toggleClass("activate");
//   //-----------------
//   $(".hamburger").toggleClass("activate");
//   // --------------------
//   // $(".nav-open").toggleClass("activate");
// });

// $(".dark-mode-icon").click(() => {
//   $(".light-mode-icon").toggleClass("active-mode");
//   $(".dark-mode-icon").toggleClass("active-mode");
//   //------------------------------
//   $("body").toggleClass("activate");
